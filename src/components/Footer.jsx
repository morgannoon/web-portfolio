          ...
          <div className="case">
            ...
            <div className="case" style={{ flexDirection: "row" }}>
              <a href="https://www.linkedin.com/in/morganenoonan" target="_blank">
                <img className="case img" src="../../../../public/images/linkedin.png" alt="LinkedIn" />
              </a>
              <a href="https://github.com/morgannoon" target="_blank">
                <img className="case img" src="../../../../public/images/gitcat.png" alt="git hub" />
              </a>
              <a href="https://www.instagram.com/ganmor_n" target="_blank">
                <img className="case img" src="../../../../public/images/insta.png" alt="instagram" />
              </a>
              <a href="https://www.goodreads.com/user/show/187083363-morgan-noonan" target="_blank">
                <img className="case img" src="../../../../public/images/goodreads.png" alt="good reads" />
              </a>
            </div>
          </div>
          contacts
            ...
            <div className="case contacts">
              <div className="contact-item">
                <a href="tel:+19733036115">
                  <img className="case img" src="../../../../public/images/phone.png" alt="phone" />
                  (973) 303-6115</a>
              </div>
              <div className="contact-item">
                <a href="mailto:morgannoon2@gmail.com">
                  <img className="case img" src="../../../../public/images/email.png" alt="email" />
